...
covid_data_aggregated <- covid_data_aggregated %>%
  distinct(fips, .keep_all = TRUE)
...
county_centroids <- merge(covid_data_aggregated, counties, by = "fips", all.x = TRUE)
...
covid_data_with_centroids <- covid_data[counties, on = "fips", nomatch = 0]
